...
}
{
        ...
        <div class="footer-bg">
            <section class="footer-container">
                <div class="footer-leng-about">
                    ...
                    <h3>Visit here!</h3>
                    <div class="leng-with-footer"><a href="">HTML</a><a href="">CSS</a><a href="">JavaScript</a><a
                            href="">React</a><a href="">NodeJs</a>
                    </div>
    ...
    document.getElementById("footer").innerHTML = footerRender;
}